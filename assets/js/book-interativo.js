const bookTemas = {
  ...
  2: {
    ...
    cor: "#969355",
    esquerda: [
      "Uma meta-análise com crianças e adolescentes expostos a trauma identificou prevalência geral de TEPT de 15,9% (Alisic <em>et al</em>., 2014). Essa prevalência se eleva a 25% em crianças e adolescentes submetidos a experiências traumáticas interpessoais.",
    ],
    direita: [
      "Em crianças e adolescentes do sexo feminino, a prevalência vai a 32,9% naquelas submetidas aos traumas interpessoais. E essa prevalência elevada em crianças e adolescentes, além do sofrimento que determina nesse ciclo de vida, impactará na saúde mental na vida adulta.",
    ],
  },
  3: {
    titulo: "Tema 3",
    cor: "#C3934C",
    esquerda: [
      "A dimensão mais importante da experiência traumática trazida pelos estudos epidemiológicos recentes a ser destacada aqui, contudo, diz respeito à sua posição de determinação e correlação (a comorbidade antes já era admitida) com a saúde física e com transtornos mentais em geral. Destaque para as apresentações mais graves e persistentes, e particularmente para a experiência psicótica em sentido amplo e apresentações mais específicas, tal como a esquizofrenia. ",
    ],
    direita: [
      "Vamos destacar aqui apenas as evidências trazidas por estudos e revisões mais recentes, robustas e de qualidade.",
    ],
  },
  4: {
    titulo: "Tema 4",
  ...
  6: {
    ...
    direita: [
      ...
      "Quando analisadas experiências específicas, os riscos mais altos apareceram em casos de violência doméstica, seguidos por negligência, abuso sexual, <em>bullying</em> e problemas de saúde mental nos pais, entre outras situações adversas.",
    ],
  },
  7: {
    titulo: "Tema 7",
  ...
  9: {
    ...
    cor: "#AE5E35",
    esquerda: [
      "Essas evidências sobre correlação e determinação transdiagnóstica da experiência traumática com desfechos diversos de saúde e saúde mental em particular produziram, nos últimos anos, a necessidade de colocar o trauma e as experiências traumáticas como um elemento essencial das propostas de cuidados no campo da saúde mental. Estão sendo produzidas diversas propostas que advogam um modelo de cuidado orientado pelo trauma, “<em>trauma informed care</em>” (cuidado baseado no trauma – trauma informado). ",
    ],
    direita: [
      "Praticamente, toda a literatura mundial recente sobre o cuidado, a crise e as situações de urgência e emergência convocam abordagens informadas pelo trauma (Haines-Delmont <em>et al</em>., 2024).",
    ],
  },
  10: {
    titulo: "Tema 10",
    cor: "#81766B",
    esquerda: [
      "Uma das principais agências norte-americanas nas áreas da organização e gestão do cuidado em saúde mental, a Substance Abuse and Mental Health Services Administration (SAMHSA), produziu um guia de orientação para estabelecer cuidados informados pelo trauma (SAMHSA, 2014). A OMS e a Associação Mundial de Psiquiatria produziram um documento conjunto advogando os cuidados baseados em <em>recovery</em> e informados pelo trauma como dimensões fundamentais para as redes de cuidados superarem o ambiente de coerção presente nos serviços (Gill <em>et al</em>., 2024).",
    ],
    direita: [
      "O programa <em>QualityRights</em> da OMS, no seu módulo de treinamento visando acabar com as práticas coercivas, orienta, também, o cuidado baseado em <em>recovery</em> e informado pelo trauma como a base da superação do panorama atual persistente da coerção no campo da saúde mental. Uma revisão recente analisando os diversos modelos criados não valida quaisquer deles como referência, mas considera que grandes avanços estão ocorrendo e que alguns componentes do cuidado informado pelo trauma podem ser incorporados à prática (Nguyen-Feng <em>et al</em>., 2025).",
    ],
  },
};
